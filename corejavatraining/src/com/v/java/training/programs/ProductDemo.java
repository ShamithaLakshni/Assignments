...
public class ProductDemo {
	...
	ArrayList<Product> product=new ArrayList<Product>();
	          ...
	          product.add(new Product(1,"banana","fruits",23000,21));
	          product.add(new Product(2,"watermelon","fruits",22000,23));
	          product.add(new Product(3,"grapes","fruits",21000,20));
	          product.add(new Product(4,"fridge","electronics",24000,42));
	          product.add(new Product(5,"mango","fruits",25000,21));
